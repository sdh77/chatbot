...
def tree_logic(user_message):
    ...
    if parent_state == "initial":
        if child_state == "initial":
            ...
            # 대화 스크립트 추가
            elif "안녕" in user_message or "여보세요" in user_message or "키 오 스 키 아" in user_message or "스퀘어" in user_message or "티오" in user_message or "새끼" in user_message or "스키" in user_message or "스 키" in user_message or "키 오" in user_message or "키즈 키야" in user_message or "큐스키" in user_message:
